...
async def create_invoice(
    ...
    await verify_workspace_access(workspace_id, user)
    return await NavigatorService.create_invoice(invoice_data, workspace_id, user['id'])
...
async def update_invoice(
    ...
    """Update an invoice"""
    await verify_workspace_access(workspace_id, user)
    return await NavigatorService.update_invoice(invoice_id, invoice_data, workspace_id)
